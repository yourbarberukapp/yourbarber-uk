        ...
        <div style={{ background: '#111', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 8, padding: '2rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            ...
            <button 
              ...
              disabled={loading}
              style={{ ...oauthBtnStyle, background: 'rgba(200,241,53,0.08)', borderColor: 'rgba(200,241,53,0.25)', color: '#C8F135' }}
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M7.5 4.27l9 5.15M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/></svg>
              ⚡ Demo: Barber Mode
            </button>
            <button 
              onClick={async () => {
              ...
              disabled={loading}
              style={{ ...oauthBtnStyle, background: 'rgba(200,241,53,0.12)', borderColor: 'rgba(200,241,53,0.35)', color: '#C8F135' }}
            >
          ...
          <p style={{ color: 'rgba(255,255,255,0.25)', fontSize: '0.7rem', textAlign: 'center', marginTop: '1.5rem' }}>
            <a href="/demo-hub" style={{ color: '#C8F135', textDecoration: 'none' }}>Open full Demo Hub →</a>
          </p>
        </div>
      </div>
    </div>
