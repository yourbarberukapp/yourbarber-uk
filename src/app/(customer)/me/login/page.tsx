...
export default function CustomerLoginPage() {
  ...
  async function verify() {
    ...
    if (res.ok) {
      ...
      setError("That code didn't match. Check your Wallet pass or card.");
    }
  }
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: '0.875rem', margin: '0 0 1.75rem', lineHeight: 1.5 }}>
          Enter the 5-letter code from your Wallet pass or barber&apos;s card.
        </p>
      ...
      <p style={{
        marginTop: '1.5rem', color: 'rgba(255,255,255,0.15)',
        fontSize: '0.7rem', textAlign: 'center',
        fontFamily: "'Barlow Condensed',sans-serif",
        textTransform: 'uppercase', letterSpacing: '0.1em',
      }}>
        No code? Scan the QR on your Wallet pass, or ask your barber.
      </p>
