...
const pillars = [
  {
    ...
    image: '/showcase-record.png?v=2',
    imageAlt: 'Cut Passport view showing haircut photos and notes on a tablet in a barbershop',
  ...
  },
  {
    ...
    image: '/demo-kiosk.png?v=2',
    imageAlt: 'Wall check-in screen in a barbershop with the QR queue system ready for customers',
